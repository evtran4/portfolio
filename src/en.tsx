...
import blueberry from '../public/bluberry.jpg'
...
export const aboutMe = {
  paragraphs: ["Outside of software engineering, I am an avid lover of nature and music. If not coding, you can always find me outside on a hiking, fishing, or playing Tennis and Pickleball with my friends! I also love GeoCaching, and am working my way towards my 100th cache. To relax and destress, I almost always play my guitar and piano, or listen to my favorite bands like The Beatles, Queen, and The Strokes!"],
  images: [
    {
    image: guitarImage,
